  ...
  return (
    <Content>
      ...
      <Iframes
        ...
        url="https://jsfiddle.net/neriGabriel/Lszm5w7y/5/embedded/js/"
      />
      ...
      <Iframes
        ...
        url="https://jsfiddle.net/neriGabriel/Lszm5w7y/31/embedded/js/"
      />
      <Iframes
        description="how to use string padding 3 "
        url="https://jsfiddle.net/neriGabriel/Lszm5w7y/35/embedded/js/"
      />
      <Iframes
        description="how to use string padding 4 "
        url="https://jsfiddle.net/neriGabriel/Lszm5w7y/38/embedded/js/"
      />	
      ...
      <Iframes
        ...
        url="//jsfiddle.net/neriGabriel/Lszm5w7y/59/embedded/js/"
      />
    </Content>
  )
}
